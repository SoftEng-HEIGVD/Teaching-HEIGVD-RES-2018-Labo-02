...
/**
 * This class implements the Roulette protocol (version 2), based on RouletteV1ClientHandler
 *
    ...
    while (!done && ((command = reader.readLine()) != null)) {
      ...
      switch (command.toUpperCase()) {
        ...
        case RouletteV2Protocol.CMD_LOAD:
          ...
          writer.println(JsonObjectMapper.toJson(new LoadCommandResponse(statu, store.getNumberOfStudents() - nbStudentsBefore)));
          writer.flush();
          break;
          
        case RouletteV2Protocol.CMD_BYE:
          done = true;
          writer.println(JsonObjectMapper.toJson(new ByeCommandResponse("success", numberCommands)));
          writer.flush();
          break;

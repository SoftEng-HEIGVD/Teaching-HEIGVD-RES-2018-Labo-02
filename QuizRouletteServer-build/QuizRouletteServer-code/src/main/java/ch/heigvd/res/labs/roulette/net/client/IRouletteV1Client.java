...
public interface IRouletteV1Client {
   ...
   /**
    * Establishes a connection with the server, given its IP address or DNS name and
    * its port.
    *
   ...
   /**
    * Adds a list of students in the server database, by issuing the 'LOAD' command
    *
    * @param students
    * @throws IOException
    */
   ...
   /**
    * Asks the server to select a random student, by issuing the 'RANDOM' command and
    * converting the result from json into a Student instance
    *

...
public interface IRouletteV1Client {
    ...
    /**
     * Returns the number of commands send by the client
     *
     * @return the number of commands send by the client
     */
    public int getNumberOfCommands();

    /**
     * Returns the number of students added by the client
     *
     * @return the number of students added by the client
     */
